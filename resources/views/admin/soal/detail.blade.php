                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <form id="delete-paket-{{ $paket->id }}" action="{{ route('admin.soal.paket.destroy', $paket->id) }}" method="POST">
                                @csrf @method('DELETE')
                            ...
                            <a href="{{ route('admin.soal.paket', $paket->id) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 text-blue-600 text-xs font-semibold rounded-lg hover:bg-blue-50 hover:border-blue-200 transition shadow-sm">
                                Buka
...
<form id="form-create-klasifikasi" action="{{ route('admin.soal.paket.store') }}" method="POST" style="display:none;">
    @csrf
...
function openEditKlasifikasi(id, judul, deskripsi) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.action = `{{ url('admin/soal/paket') }}/${id}`;
