...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <p class="text-sm text-slate-500">Rekapitulasi total pertanyaan yang terdaftar di bank soal berdasarkan Mata Pelajaran dan Kelas.</p>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('admin.soal.detail', ['mapel_id' => $row->mapel_id, 'kelas' => $row->kelas]) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 text-slate-600 text-xs font-semibold rounded-lg hover:bg-slate-50 hover:text-blue-600 hover:border-blue-200 transition shadow-sm">
                ...
                @empty
                <tr><td colspan="5" class="px-6 py-8 text-center text-slate-400">Belum ada Bank Soal yang didaftarkan.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
