        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <form action="{{ route('admin.soal.update', $soal) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="p-4 bg-blue-50/50 border border-blue-100 rounded-xl mb-6">
                    <p class="text-sm text-blue-800 font-medium">Klasifikasi: <span class="font-bold">{{ $soal->paketSoal ? $soal->paketSoal->judul : 'Tidak Ada' }}</span></p>
                </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    ...
                    <a href="{{ route('admin.soal.paket', $soal->paket_soal_id) }}" class="px-6 py-2.5 bg-slate-100 text-slate-600 text-sm font-semibold rounded-xl hover:bg-slate-200 transition">Batal</a>
                </div>
            </form>
        </div>
    </div>
