    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        ...
        <div class="mb-6 flex items-start gap-4 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
            ...
            <div>
                ...
                <div class="mt-3">
                    <a href="{{ route('admin.soal.template') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white text-emerald-700 text-xs font-semibold rounded-lg hover:bg-emerald-50 transition border border-emerald-200">
        ...
        <form @submit.prevent="submitForm">
            ...
            <div class="flex items-center gap-3 pt-5">
                ...
                <a href="{{ route('admin.soal.paket', $paket_soal->id) }}" class="px-6 py-2.5 bg-slate-100 text-slate-600 text-sm font-semibold rounded-xl hover:bg-slate-200 transition" x-show="!isUploading">Kembali</a>
            </div>
        </form>
        ...
        <div x-show="showProgress" class="mt-8 border-t border-slate-100 pt-6" style="display: none;">
            ...
            <div x-show="isComplete" class="mt-6 flex justify-end" style="display: none;">
                <a href="{{ route('admin.soal.paket', $paket_soal->id) }}" class="px-6 py-2.5 bg-slate-800 text-white text-sm font-semibold rounded-xl hover:bg-slate-900 transition flex items-center gap-2">
                    Lihat Soal
                </a>
            </div>
        </div>
    ...
    Alpine.data('soalImportData', () => ({
        ...
        async submitForm() {
            ...
            try {
                ...
                xhr.open('POST', "{{ route('admin.soal.import', $paket_soal->id) }}", true);
