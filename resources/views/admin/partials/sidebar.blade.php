...
<a href="{{ route('admin.settings.index') }}" title="Pengaturan" :class="sidebarMinimized ? 'justify-center px-2' : 'gap-3 px-4'" class="flex items-center py-2.5 rounded-xl {{ request()->routeIs('admin.settings.*') ? 'bg-white/10 text-white font-medium' : 'text-slate-300 hover:bg-white/10 hover:text-white' }} text-sm transition">
