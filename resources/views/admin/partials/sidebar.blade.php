...
<a href="{{ route('admin.dashboard') }}" title="Dashboard" :class="sidebarMinimized ? 'justify-center px-2' : 'gap-3 px-4'" class="flex items-center py-2.5 rounded-xl {{ request()->routeIs('admin.dashboard') ? 'bg-white/10 text-white font-medium' : 'text-slate-300 hover:bg-white/10 hover:text-white' }} text-sm transition">
...
<a href="{{ route('admin.settings.seb') }}" title="Pengaturan SEB" :class="sidebarMinimized ? 'justify-center px-2' : 'gap-3 px-4'" class="flex items-center py-2.5 rounded-xl {{ request()->routeIs('admin.settings.seb') ? 'bg-white/10 text-white font-medium' : 'text-slate-300 hover:bg-white/10 hover:text-white' }} text-sm transition">
    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
    <span x-show="!sidebarMinimized" x-transition.opacity class="whitespace-nowrap">Pengaturan SEB</span>
</a>
<a href="{{ route('admin.settings.index') }}" title="Pengaturan" :class="sidebarMinimized ? 'justify-center px-2' : 'gap-3 px-4'" class="flex items-center py-2.5 rounded-xl {{ request()->routeIs('admin.settings.index') ? 'bg-white/10 text-white font-medium' : 'text-slate-300 hover:bg-white/10 hover:text-white' }} text-sm transition">
    ...
    <span x-show="!sidebarMinimized" x-transition.opacity class="whitespace-nowrap">Pengaturan</span>
</a>
