        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
            <form action="{{ route('admin.siswa.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="kelas" value="{{ old('kelas') }}" required placeholder="Contoh: XII-A" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition outline-none">
                </div>
