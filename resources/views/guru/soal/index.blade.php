...
@section('content')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <p class="text-sm text-slate-500">Soal berdasarkan ujian yang ditugaskan kepada Anda.</p>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden mb-6">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-500 mt-0.5">{{ $ujian->soals->count() }} soal</p>
            </div>
            @if($ujian->is_active)
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50">
                        ...
                        <td class="px-6 py-3.5">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('guru.soal.edit', $soal) }}" class="p-2 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition">
                    ...
                    @empty
                    <tr><td colspan="4" class="px-6 py-6 text-center text-slate-400">Belum ada soal untuk ujian ini.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
