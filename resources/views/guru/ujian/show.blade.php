...
@section('content')
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-red-50/30 transition">
                        ...
                        <td class="px-6 py-3.5">
                            <form id="reset-form-{{ $progress->siswa_id }}" action="{{ route('guru.ujian.reset-peserta', [$ujian, $progress->siswa_id]) }}" method="POST" class="inline">
                                @csrf
    ...
    <div class="mt-6">
        <a href="{{ route('guru.ujian.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-slate-100 text-slate-600 text-sm font-semibold rounded-xl hover:bg-slate-200 transition">
